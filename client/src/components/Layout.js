            ...
            <div className="d-flex layout">
                ...
                <div className="content">
                    <div className="header">
                        { collapse ? <i className="ri-menu-2-fill header-action-icon" onClick={ () => setCollapse(false)}></i> : <i className="ri-close-fill header-action-icon" onClick={ () => setCollapse(true)}></i> }
